...
CC_DEPS += \
./tensorflow-lite/tensorflow/lite/schema/schema_utils.d 
...
tensorflow-lite/tensorflow/lite/schema/%.o tensorflow-lite/tensorflow/lite/schema/%.su tensorflow-lite/tensorflow/lite/schema/%.cyclo: ../tensorflow-lite/tensorflow/lite/schema/%.cc tensorflow-lite/tensorflow/lite/schema/subdir.mk
...
clean: clean-tensorflow-2d-lite-2f-tensorflow-2f-lite-2f-schema

clean-tensorflow-2d-lite-2f-tensorflow-2f-lite-2f-schema:
	-$(RM) ./tensorflow-lite/tensorflow/lite/schema/schema_utils.cyclo ./tensorflow-lite/tensorflow/lite/schema/schema_utils.d ./tensorflow-lite/tensorflow/lite/schema/schema_utils.o ./tensorflow-lite/tensorflow/lite/schema/schema_utils.su

.PHONY: clean-tensorflow-2d-lite-2f-tensorflow-2f-lite-2f-schema
